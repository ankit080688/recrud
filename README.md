...
The frontend expects the backend API to be running at `http://localhost:5000`. If your backend is hosted elsewhere, edit `frontend/src/api.js` and update the `API_BASE` constant to the appropriate base URL.
